          ...
          <el-table :data="manyTableData" border stripe>
            <el-table-column type="expand">
              <template slot-scope="scope">
                <el-tag v-for="(item, i) in scope.row.attr_vals" :key="item.attr_id" closable @close="handleClose(i,scope.row)">{{item}}</el-tag>
                <!-- 输入的文本框 -->
                <el-input
                  class="input-new-tag"
...
export default {
  ...
  methods: {
    ...
    showInput(row) {
      ...
      // 获得文本输入框的焦点
      // $nextTick 作用：当页面上元素被重新渲染之后，才会制定灰调函数中的代码
      this.$nextTick(_ => {
